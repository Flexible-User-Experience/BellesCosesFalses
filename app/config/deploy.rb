...
# Config #
##########
set :application,       "Relat de Belles Coses Falses"
set :domain,            "s3.flux.cat"
set :deploy_to,         "/home/flux/webapps/lopati-bellescosesfalses"
set :app_path,          "app"
set :cache_dir,         "/cache"
...
# SCM Repository #
##################
set :repository,        "git@github.com:Flexible-User-Experience/BellesCosesFalses.git"
set :scm,               :git
set :branch,            "master"
